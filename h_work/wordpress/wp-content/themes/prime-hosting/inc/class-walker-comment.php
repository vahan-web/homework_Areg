...
if ( ! class_exists( 'Prime_Hosting_Walker_Comment' ) ) {
	/**
	 * CUSTOM COMMENT WALKER
	 * A custom walker for comments, based on the walker in Twenty Nineteen and Twenty Twenty.
	 */
	class Prime_Hosting_Walker_Comment extends Walker_Comment {
		...
		protected function html5_comment( $comment, $depth, $args ) {
			...
			<<?php echo $tag; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- static output ?> id="comment-<?php comment_ID(); ?>" <?php comment_class( $this->has_children ? 'parent' : '', $comment ); ?>>
				...
				<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
					<div class="commmt_info group-sm group-justify">
						<div>
					...
					<div class="comment-content">
						...
						if ( '0' === $comment->comment_approved ) {
							?>
							<p class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'prime-hosting' ); ?></p>
							<?php
						}
						?>
					</div><!-- .comment-content -->
